export const navItems = [
  ...
  export const gridItems = [
    {
      id: 1,
      title: "Pursuing a degree in CSE from Indian Institue of Information Technology Sricity(IIITS)",
      description: "",
  ...
  export const workExperience = [
    {
      id: 1,
      title: "Full Stack Developer Intern - StockZo",
      desc: "Assisted in the development of a web-based platform using React.js, enhancing Backend",
